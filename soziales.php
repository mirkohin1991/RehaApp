...
// Hier wird jeweils reingeschrieben um welche Seite es sich handelt
 $_SESSION['xmlSource'] = "/SozialesContent/Soziales.xml";
 $_SESSION['pageSource'] = "soziales.php";
      ...
      <div class="mainmenu">
        <div id="mainmenu">
          <ul class="sf-menu">
            ...
            <li><a href="soziales.php" id="visited"><span class="home"><img src="images/sozial.png" alt="" /></span>Soziales</a></li>
            <li><a href="speiseplan.php"><span class="home"><img src="images/speiseplan.png" alt="" /></span>Speiseplan</a></li>
...
<div class="one_third contactsidebar">
    <section class="first">
      ...
      <ul class="contactsidebarList">
        ...
        <li>Hier kÃ¶nnen Sie die Texte eingeben, die auf der Startseite der App angezeigt werden.</li>
      </ul>
    </section>
  </div>
  <!-- one_third ends here -->
  ...
  <div class="two_third lastcolumn contact1">
    <div id="contactForm">
      <h2>Inhalte der Soziales Seite</h2>
      <div class="sepContainer"></div>
                  ...
                  <?php
					...
					$test = '<div class="toggle-container">
	               ...
	               <form action="save.php?nodeID=' . $i . '" method="post"  id="contact_form">
					...
					<div class="kurztext">
						<label for="kurztext">Kurztext:</label> <textarea id=shortText name=shortText type=text required style="height:50px;" />' . getShorttext( $i ) . '</textarea>
					</div>
					...
					<div id="loader">
						...
						<input type="submit" name="deleteContent" value="Löschen" style="float:right; margin-right: 2.5%" />
					</div>
				...
				<div class="toggle-container">
					<form
						...
						<div class="name">
							<label for="name">Überschrift:</label> 
							<input id="heading" name="heading" type="text" />
						</div>
						
						<div class="kurztext">
							<label for="kurztext">Kurztext:</label> 
							<textarea id="shortText" name="shortText" type="text" style="height:50px;"></textarea>
					   </div>

						<div class="message">
							<label for="message">Text:</label>
							<textarea id="text" rows="15" name="text"></textarea>
						</div>
						<div id="loader">
							<input type="submit" name="saveContent" value="Speichern" />
						</div>
