      ...
      <div class="mainmenu">
        <div id="mainmenu">
          <ul class="sf-menu">
            ...
            <li><a href="news-infos.php" id="visited"><span class="home"><img src="images/news.png" alt="" /></span>News / Infos</a></li>
          </ul>
        </div>
...
================================================== -->
    ...
    <div class="two_third lastcolumn contact1">
      <div id="contactForm">
        <h2>Inhalte der News / Infos Seite</h2>
        <div class="sepContainer"></div>
          ...
          <div class="message">
            ...
            <textarea id=text name=text>' . getLongtext ( $i ) . '</textarea>
          </div>
          <div id="loader">
